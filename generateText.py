...
# Create a Tracery grammar instance with base_english modifiers
tracery_grammar = Grammar({
    "story": ["Once upon a time, there was a #character#.", "There was a #character# who lived in a #location#.", "In a #location#, there was a #character#."],
    "character": ["princess", "prince", "dragon", "witch"],
    "location": ["castle", "forest", "mountain", "village"]
})
tracery_grammar.add_modifiers(base_english)
...
def generate_text():
    # load the grammar from tracery_grammar.py
    grammar = tracery_grammar
    # create a Tracery instance
    tracery_instance = tracery.Tracery(grammar)
    # generate and return the text
    return tracery_instance.flatten("#story#")
...
text = ""
prefix = tracery_grammar.flatten("#story#")  # initialize prefix
chunks = []
