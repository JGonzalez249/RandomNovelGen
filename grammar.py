...
def get_grammar():
    ...
    rules = {
        ...
        "#hero.capitalize# #action# #modifier# and must uncover the conspiracy to control #planet# and must #goal#",
    ...
    "action": ["wakes up", "travels forward in time", "travels to a distant planet", "gains the power of #superpower#", "is tasked with building", "is a"],
    ...
    "technology": ["robotics", "holography", "teleportation", "time travel", "antigravity", "cloning", "stem cells", "nanobots", "superconductors", "lasers", "space travel", "terraforming", "warp drive", "wormholes", "dyson spheres exist", "mind uploading is possible", "brain-computer interface", "simulated reality", "digital immortality", "mind control"],
    ...
    "challenge": ["outwit the government", "uncover a hidden truth", "rescue a loved one who", "save the planet from destruction", "solve a mystery"],
    ...
    # Add a modifier to capitalize the first letter of generated sentences
